...
const { 
  FiHome, FiUsers, FiCheckSquare, FiMessageSquare, FiMic, 
  FiHardDrive, FiShield, FiGrid, FiTool, FiSettings, FiX 
} = FiIcons;
...
const Sidebar = ({ isOpen, onClose }) => {
  ...
  if (isManager) {
    navigationItems.splice(1, 0, { name: 'User Management', href: '/users', icon: FiUsers });
  }
